    ...
    <header className="header" style={{color: "white", borderColor: "#5b8b9b"}}>
      <Fade>
        ...
        <ul className="hidden text-theme-blue tracking-widest items-center lg:flex flex-row mt-0">
          ...
          <li className="py-2 lg:py-0">
            <Button
              className={`${path === '/Portfolio' ? 'active-link' : ''} text-lg px-5 no-underline hover:underline`}
              type="link"
              href="/Portfolio"
            >
              Portfolio
          ...
          <li className="py-2 lg:py-0">
            <a href="/#services" className={`${path === '/services' ? 'active-link' : ''} text-lg px-5 no-underline hover:underline`}>
      ...
      >
        <Fade>
          <ul className="z-50 flex flex-col text-theme-blue tracking-widest my-6 absolute bg-white w-full border-b-2 border-gray-300 lg:hidden">
            ...
            <li className="py-2 bg-white">
              <Button
                className={`${path === '/Portfolio' ? 'active-link' : ''} px-10 no-underline hover:underline`}
                type="link"
                href="/Portfolio"
              >
                Project
