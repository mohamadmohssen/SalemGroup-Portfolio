              ...
              data.map((item, index) => (
                <Fade bottom delay={500 * index}>
                  <div onClick={() => toPage(item.pagePath)}>
                    ...
                    <div className="bg-white group rounded-2xl shadow-2xl border border-light-theme-purple transform transition duration-500 hover:scale-105" style={{width:"450px"}}>
