        ...
        >
          {
                        data.map((item) => (
                          <SplideSlide>
                            <div className="flex-col xl:w-4/5 rounded-2xl shadow-xl sm:shadow-2xl focus:#367588 border border-light-theme-blue px-8 py-6 mx-2 mb-6 mt-6 xl:mx-auto sm:mx-6 sm:mb-12">
